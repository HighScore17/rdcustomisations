											...
											if ( true === $wcal_check_cart_total ) {
												...
												if ( $email_sent_id > 0 ) {
													...
													if ( isset( $is_wc_template ) && '1' === $is_wc_template ) {
														...
														$args = woocommerce_abandon_cart_lite::wcal_filter_email_data( $user_email, $email_subject, $final_email_body, $headers, array(
															"firstname" => $user_first_name,
															"lastname" => $user_last_name,
															"session" => $cart_info_db_field,
														));
														if( !$args["sended"] ) {
														...
														$args = woocommerce_abandon_cart_lite::wcal_filter_email_data( $user_email, $email_subject, $email_body_final, $headers, array(
															"firstname" => $user_first_name,
															"lastname" => $user_last_name,
															"session" => $cart_info_db_field,
														));
													...
													do_action( 'wcal_send_email', $user_email, $template_name );
												}
											}
										}
									}
