...
Tags: WooCommerce coupon, url coupons, gift coupons, signup coupons, coupons, smart coupons, advanced coupons, woocommerce smart coupons, woocommerce, url coupons for woocommerce,  extended coupons, auto coupons,  smart coupons for woocommerce,  coupon category
...
Smart Coupons For WooCommerce Coupons adds advanced options to default WooCommerce coupons that lets you create a variety of coupon restrictions, enable auto-apply of coupons, giveaway offers, easy coupon management, and more.  
...
* <strong>Apply coupon restrictions</strong>: Restrict coupon usage on the basis of products, categories and user role.
...
* <strong>Give away coupons</strong>: Embed [giveaway product](https://www.webtoffee.com/how-to-offer-giveaway-in-woocommerce/) to coupons.

* <strong>Categorize coupons</strong>: Make coupon management easy on the backend by grouping coupons into categories.
...
* <strong>Displays available coupons on cart and checkout page </strong>: The customers can view the available coupons from cart as well as from checkout page.

* <strong>Coupon shortcodes</strong>: Shortcodes are auto-created for all coupons in your store. You can use coupon shortcodes to display the coupon code, description or a discount info derived from the coupon settings anywhere in your site.
...
### NEED FOR THIS WOOCOMMERCE SMART COUPONS PLUGIN ###
...
<strong>Duplicate coupons</strong>: If new coupons need to be created having configurations similar to any of the existing coupons, you can simply duplicate them then create them from scratch.
...
* **Display applicable coupons on My Account, Cart, and Checkout** pages. 
* **Categorized view of Active/Used/Expired coupons** from My Account > My Coupon.
* Provision to use **combo coupon** for purchase.
* **Coupon shortcodes** for displaying coupons on any page.


For a complete list of features and details, please visit [Smart Coupons for WooCommerce](https://www.webtoffee.com/product/smart-coupons-for-woocommerce/).


###URL coupons###

Smart coupons for WooCommerce plugin comes with a URL coupons feature that help you add a unique URL to any coupon in your WooCommerce store. Clicking this URL ensures that the underlying coupon is applied as per its respective configuration eg: allow discounts, giveaway free product, etc. 
...
URL coupons for WooCommerce is a paid add-on that adds advanced URL coupons features to both the free and pro versions of the Smart Coupons for WooCommerce plugin. 
...
Yes. This WooCommerce coupon plugin lets you create coupons based on the number of products purchased. 
= Is it possible to generate coupon URL's using the plugin?
