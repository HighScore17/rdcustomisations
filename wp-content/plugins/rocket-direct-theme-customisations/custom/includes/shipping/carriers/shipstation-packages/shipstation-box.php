...
class Box_Package {
   ...
   */
  static function create_from_package( $package ) {
    $box = new Box_Package( __vector_3D( $package->get_length(), $package->get_width(), $package->get_height() ), $package->get_total_weight());
    $box->addItem( $package );
    $box->close_column();
    return $box;
  }  
