...
class Shipping_Carrier {
   ...
   */
  function do_rate_quote( $service_code, $ship_from, $ship_to, $packages, $accessorials ) {
    ...
    return $this->do_api_request( $service_code, $ship_from, $ship_to, $packages, $accessorials );
  }
   ...
   */
  function validate_input( $service_code, $ship_from, $ship_to, $packages, $accessorials ) {
    return TRUE;
  }
  ...
  function is_sandbox_mode_enabled() {
