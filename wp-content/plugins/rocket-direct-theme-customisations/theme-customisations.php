...
define('HORIZON_CUSTOMISATIONS_DIR', __DIR__);
define('HORIZON_CUSTOMISATIONS_FILE', __FILE__);
define( 'GRAPHQL_JWT_AUTH_SECRET_KEY', 'ZpbeONNbqMnfgJsiwv8giGhbxYWro1AH' );
require_once( 'custom/includes/tables/main.php' );
/**
...
register_activation_hook( HORIZON_CUSTOMISATIONS_FILE, 'horizon_plugin_activation_create_tables' );
