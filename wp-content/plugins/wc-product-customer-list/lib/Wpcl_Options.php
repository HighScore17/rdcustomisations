...
class Wpcl_Options
{
    ...
    public static function get_table_options()
    {
        ...
        if ( class_exists( 'WC_Subscriptions' ) && wpcl_activation()->is__premium_only() ) {
            ...
            $premium_columns['wpcl_subscription_billing_period'] = [
                'is_premium'         => true,
                'is_column'          => true,
                'default_value'      => 'no',
                'column_pretty_name' => __( 'Subscription billing period', 'wc-product-customer-list' ),
                'data_formatter'     => 'Wpcl_Data_Formatters::data_subscription_billing_period',
                'shortcode_field'    => 'subscription_billing_period',
                'shortcode_default'  => 'false',
                'is_setting'         => true,
                'setting'            => [
                'settings_order' => 2009,
                'name'           => __( 'Subscription billing period', 'wc-product-customer-list' ),
                'id'             => 'wpcl_subscription_billing_period',
                'default'        => 'no',
                'type'           => 'checkbox',
                'css'            => 'min-width:300px;',
                'desc'           => __( 'Enable subscription billing period column', 'wc-product-customer-list' ),
            ],
            ];
        }
